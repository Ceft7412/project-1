...
class ContactNumberPage extends StatefulWidget {
  const ContactNumberPage({super.key});
      ...
      if (userDoc.exists) {
        setState(() {
          ...
          phoneNumberController.text =
              userDoc.get('contact_number')?.toString() ?? '';
  ...
  Future<void> updateUserInfo() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('User').doc(userid).update({
        'contact_number': int.parse(phoneNumberController.text),
      });
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    'If you change your phone number, it will be updated on your profile.',
                                  ),
                                ),
                              ],
                            ),
